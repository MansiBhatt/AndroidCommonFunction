 ...
 * Adapter for Array list
 */

public class ArrayListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<Country> countryList;
    Context mContext;

    public ArrayListAdapter(List<Country> countryList, Context mContext) {
